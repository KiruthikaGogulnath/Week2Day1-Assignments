...
public class Week2Day1EditAssignment {
	...
	public static void main(String[] args) {
		...
		System.out.println("Assignment 2 : Edit Lead");

		System.out.println("Open the Edit button link");
		driver.findElement(By.linkText("Edit")).click();
		
		System.out.println("Clear the Description field");
		driver.findElement(By.name("description")).clear();
		
		System.out.println("Fill important note field");
		driver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("Just sample note");
